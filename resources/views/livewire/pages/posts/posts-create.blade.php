<div class="text-white mt-5 w-full flex flex-col h-screen justify-center items-center text-center bg-slate-900">
    ...
    <h2 class="mb-4 text-2xl font-bold">Buat Post Baru</h2>
    ...
    <form wire:submit.prevent="save">
        <div class="flex flex-col mb-3 text-white gap-2">
            ...
            <input type="text" class=" text-black w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-500 @error('title') border-red-500 @enderror" wire:model="title">
        ...
        <div class="mb-3 flex flex-col gap-2">
            ...
            <input type="text" class="text-black w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-500 @error('tags') border-red-500 @enderror" wire:model="tags">
        ...
        <div class="mb-3  flex flex-col gap-2">
            ...
            <input type="file" class="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-500 @error('image') border-red-500 @enderror" wire:model="image">
        ...
        <button type="submit" class=" bg-white hover:bg-gray-400 text-slate-900 font-bold py-2 px-4 rounded">Simpan</button>
    </form>
     </div>
</div>
