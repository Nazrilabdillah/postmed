<div class=" text-black overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div class="relative h-35 md:h-65">
                  <img src="https://images.unsplash.com/photo-1529778873920-4da4926a72c2?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y3V0ZSUyMGNhdHxlbnwwfHwwfHx8MA%3D%3D" alt="profile cover" class="h-[10rem] w-full rounded-tl-sm rounded-tr-sm object-cover object-center -z-0">
                  <div class="absolute bottom-1 right-1  xsm:bottom-4 xsm:right-4">
                ...
                <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                  <div class="relative overflow-hidden mx-auto mt-[-6rem] h-30 w-full max-w-30 rounded-full z-40 bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
                    <div class="relative drop-shadow-2 w-full">
                      <img src="https://thumbs.dreamstime.com/b/boy-disguised-mask-profile-avatar-fake-nose-mustache-glasses-cartoon-character-vector-illustration-graphic-design-149133502.jpg" alt="profile" class="w-full object-cover rounded-full">
                  ...
                  <div class="mt-4">
                    ...
                    <div class="flex flex-col w-full justify-center items-center my-4">
